...
cfg = {
    ...
    animActive = false,
    animDuration = 5500, -- You can change this but I recommend not to.
    animLoop = false,
    animMovement = true,
    animDisableMovement = true,
    ...
    defaultEmote = 'handsup', -- Default emote by default
    defaultEmoteUseKey = true, -- Don't recommend setting this to false unless you change UI
    defaultEmoteKey = 48 -- Default emote command key
}